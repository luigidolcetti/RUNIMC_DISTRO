...
#'
#' An IMC analysis is composed of few objects contained in the IMC_Study
...
#'   study IMC_Study and on disk, essentially overwriting the analysis object
...
#' @return a new analysis IMC_Study in MyStudy$currentAnalysis.
#' @examples
#' \dontrun{
...
setMethod('an_dismissAnalysis',signature = ('IMC_Study'),
...
setMethod('an_listAnalysis',signature = ('IMC_Study'),
          function(x,...){
            x$analysis
...
#'
#' Current analysis is an IMC_Study containing multiple objects.
#' [an_showCurrentAnalysis()] lists the objects contained in the currentAnalysis
#' IMC_Study and assess whether each object is **initialized** or **empty**.
#'
#' @param x IMC_Study, a study.
...
setMethod('an_showCurrentAnalysis',signature = ('IMC_Study'),
          function(x,...){
